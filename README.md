...
| `OGMA_DREAM_MODEL` | nightly dream model; setup aligns it with the harness/model | selected model/default |
...
automatically and also switches the nightly dream model.
